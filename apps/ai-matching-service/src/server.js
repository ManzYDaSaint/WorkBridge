...
const buildServer = (opts = {}) => {
  ...
  const logger = pino(
    ...
    pino.destination({ dest: path.join(logDir, 'ai-matching-service.log'), sync: false })
  );

  const register = new client.Registry();
  client.collectDefaultMetrics({ register, prefix: 'ai_matching_service_' });
  ...
  fastify.register(require('./routes'), { prefix: '/ai' });

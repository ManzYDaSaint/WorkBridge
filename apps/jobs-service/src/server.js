...
const buildServer = (opts = {}) => {
  ...
  const logger = pino(
    ...
    pino.destination({ dest: path.join(logDir, 'jobs-service.log'), sync: false })
  );

  const register = new client.Registry();
  client.collectDefaultMetrics({ register, prefix: 'jobs_service_' });
  ...
  fastify.register(require('./routes'), { prefix: '/jobs' });

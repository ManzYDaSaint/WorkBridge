...
const buildServer = (opts = {}) => {
  ...
  const logger = pino(
    ...
    pino.destination({ dest: path.join(logDir, 'admin-service.log'), sync: false })
  );

  const register = new client.Registry();
  client.collectDefaultMetrics({ register, prefix: 'admin_service_' });
  ...
  fastify.register(require('./routes'), { prefix: '/admin' });
